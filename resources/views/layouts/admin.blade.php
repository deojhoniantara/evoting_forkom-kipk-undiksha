        ...
        <div class="w-64 bg-white shadow-lg">
            ...
            <nav class="mt-6">
                <div class="px-4 space-y-2">
                    ...
                    <a href="{{ route('voter-management.index') }}" class="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-primary hover:text-white transition-colors duration-200 {{ request()->routeIs('admin.voters') ? 'bg-primary text-white' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
